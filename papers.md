...
### Motion Verbs in English and Spanish: A Comparative Corpus Approach
*MA Thesis, University of Freiburg im Breisgau*, 2022

This dissertation examines how English and Spanish speakers describe and conceptualize motion events, drawing on Slobin’s Thinking for Speaking framework by using a two-part methodology: (1) a large corpus study and (2) an elicited narration experiment with gesture analysis. The study investigates whether typological differences between satellite-framed and verb-framed languages shape patterns in speech and co-speech gestures. Several results challenge standard predictions from Thinking for Speaking. Both languages relied more on V-framed verbs than expected, and English even showed high use of Romance-origin V-framed verbs that retain their original behaviour. Gesture analyses revealed further divergences: speakers sometimes expressed motion only through gesture with no supporting motion verb, or produced gestures that mapped imperfectly onto the number of motion events in speech. Spanish participants frequently conveyed Manner through gesture alone, while English speakers tended to segment Path into multiple gestural units. Although English narrations were slightly longer and more lexically varied, many expected typological contrasts were weaker or absent. Overall, the findings suggest that conceptualization of motion cannot be inferred from speech alone and that gesture plays an essential, semi-independent role in how motion events are represented. The research shows some inconclusive results but uses novel research methods that could be further developed inn the future.

- [Read Here](./papers/motionverbs.pdf)
- [Supporting Material](./papers/motionverbsapp.pdf)
...
- [Read Here](./papers/pratchett.pdf)
...
- [Read Here](./papers/sandwiches.pdf)
...
- [Read Here](./papers/metaphors.pdf)
